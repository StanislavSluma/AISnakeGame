...
class Button:
    ...
    def change_color(self, mouse_pos):
        if mouse_pos[0] in range(int(self.__x - self.__width / 2), int(self.__x + self.__width / 2)) and mouse_pos[1] in range(int(self.__y - self.__height / 2), int(self.__y + self.__height / 2)):
